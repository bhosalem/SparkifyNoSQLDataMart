...
create_users_listening_song = "CREATE TABLE IF NOT EXISTS users_listening_song(song text,first_name text,last_name text, PRIMARY KEY (song));"
...
insert_users_listening_song="insert into users_listening_song (song,first_name,last_name) VALUES (%s,%s,%s);"

#SELECT QUERIES
select_music_hist_in_session="select * from music_hist_in_session where sessionId=338 and iteminsession=4;"

select_user_info_in_session="select * from user_info_in_session where userid=10 and sessionid=182;"

select_users_listening_song="select * from users_listening_song where song='All Hands Against His Own';"
